...
<html lang="en">
<head>
    <title>Code coverage report for adal-ts2\src\aad.url.builder.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">adal-ts2/src/</a> aad.url.builder.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { GuidGenerator } from './guid.generator';
...
&nbsp;
        this.state = this.guidGenerator.generate()<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>this.extraQueryParameter = options.extraQueryParameter || this.extraQueryParameter;
        retu<span class="cstat-no" title="statement not covered" >rn this;</span>
    }
&nbsp;
    public build() {
<span class="missing-if-branch" title="if path not taken" >I</span>
        var <span class="cstat-no" title="statement not covered" >urlNavigate = AadUrlBuilder.MicrosoftLoginUrl + this.</span>tenant + '/oauth2/authorize';
        urlNavigate = urlNavigate + this.serialize() + this.addLibMetadata();
        <span class="missing-if-branch" title="if path not taken" >I</span>urlNavigate = urlNavigate + '&amp;nonce=' + encodeURIComponent(this.nonce);
        retu<span class="cstat-no" title="statement not covered" >rn urlNavigate;</span>
    }
&nbsp;
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Wed Mar 01 2017 17:03:37 GMT+0100 (Romance (standaardtijd))
</div>
</div>
