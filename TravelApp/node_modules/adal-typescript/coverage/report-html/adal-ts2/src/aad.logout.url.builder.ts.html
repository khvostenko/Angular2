...
<html lang="en">
<head>
    <title>Code coverage report for adal-ts2\src\aad.logout.url.builder.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">adal-ts2/src/</a> aad.logout.url.builder.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
    constructor() {<span class="branch-1 cbranch-no" title="branch not covered" ></span>
