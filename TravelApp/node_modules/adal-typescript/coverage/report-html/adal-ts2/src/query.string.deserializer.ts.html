...
<html lang="en">
<head>
    <title>Code coverage report for adal-ts2\src\query.string.deserializer.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">adal-ts2/src/</a> query.string.deserializer.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
        return hash;<span class="fstat-no" title="function not covered" ></span>
