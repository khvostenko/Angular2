...
<html lang="en">
<head>
    <title>Code coverage report for adal-ts2\src\scenario\a.production.adal.config.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../../index.html">all files</a> / <a href="index.html">adal-ts2/src/scenario/</a> a.production.adal.config.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { AdalConfig } from '../adal.config';
&nbsp;
