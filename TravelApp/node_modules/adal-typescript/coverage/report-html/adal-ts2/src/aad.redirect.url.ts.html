...
<html lang="en">
<head>
    <title>Code coverage report for adal-ts2\src\aad.redirect.url.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">adal-ts2/src/</a> aad.redirect.url.ts
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">1×</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-no">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Constants } from './constants';
&nbsp;
...
&nbsp;
    get accesToken() {
        return this.objec<span class="fstat-no" title="function not covered" >t[Constants.ACCESS_TOKEN];</span>
