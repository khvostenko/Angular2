...
let CityWhichIWantComponents = class CityWhichIWantComponents {
    ...
    Delete(id) {
        this.requestService.delete('cityWhichIWantToVisit/' + id).subscribe((resp) => {
            this.cities = this.cities.filter(x => x.Id !== id);
        });
    }
};
CityWhichIWantComponents = __decorate([
    core_1.Component({
        moduleId: module.id,
...
], CityWhichIWantComponents);
exports.CityWhichIWantComponents = CityWhichIWantComponents;
//# sourceMappingURL=citiesWhichIWant.component.js.map